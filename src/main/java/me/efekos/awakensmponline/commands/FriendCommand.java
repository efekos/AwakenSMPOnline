...
public class FriendCommand extends CoreCommand {
    ...
    public @NotNull ArrayList<Class<? extends SubCommand>> getSubs() {
        ...
        classes.add(FriendInfoCommand.class);classes.add(FriendListCommand.class);classes.add(FriendTeleportCommand.class);classes.add(FriendAddCommand.class);classes.add(FriendAcceptCommand.class);
        classes.add(FriendDenyCommand.class);classes.add(FriendCancelCommand.class);classes.add(FriendRemoveCommand.class);classes.add(FriendModifyCommand.class);classes.add(FriendInventoryCommand.class);classes.add(FriendArmorCommand.class);classes.add(FriendCompassCommand.class);
        return classes;
    }
